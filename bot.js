...
function respond() {
  var request = JSON.parse(this.req.chunks[0]),
      ...
      botRegexGian = /^\/gian/; botRegexScrotes = /^\/scrotes/; botRegexlafx = /^\/laf/;
      botRegexDaf = /^\/dafuq/; botRegexMA32 = /^\/pending/; botRegexTrade = /^\/trade/; botRegexPig = /^\/Pigs/;
  ...
  if(request.text && botRegex.test(request.text)) {
    ...
    postMessage("http://daddyleagues.com/ppl/team/"+request.text.substring(5,8)+"/depthchart");
    this.res.end();
  } 
    ...
    this.res.writeHead(200);
    postMessage("https://http://daddyleagues.com/ppl/rules");
    this.res.end();
  } 
    ...
    postMessage("http://daddyleagues.com/ppl/team/"+request.text.substring(5,8)+"/schedule");
    this.res.end();
  }
  ...
  else if(request.text && botRegexPig.test(request.text)) {
this.res.writeHead(200);
postMessage("https://media.npr.org/assets/img/2015/05/04/pig-tales_9780393240245-1-_wide-ff64be1d4945228dd4bf7f4a10cbc7b08ff9ada5.jpg?s=1400");
this.res.end();
  }
